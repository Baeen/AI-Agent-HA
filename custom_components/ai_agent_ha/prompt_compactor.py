...
class PromptCompactor:
    ...
    def estimate_messages_tokens(self, messages: List[Dict[str, Any]]) -> int:
        ...
        for msg in messages:
            ...
            total_tokens += self.estimate_tokens(msg.get("role", ""))
        return total_tokens

    def should_compact(
        self, current_tokens: int, max_tokens: int, threshold: float = 0.7
    ) -> bool:
        ...
        Args:
            ...
            threshold: Fraction threshold (0.0-1.0) to trigger compaction.
    ...
    def _generate_heuristic_summary(
        ...
        for msg in messages:
            ...
            if isinstance(content, str):
                ...
                # Extract entity-like patterns (e.g., light.living_room)
        ...
        return ConversationSummary(
            ...
            summary_token_count=self.estimate_tokens(summary_text),
    ...
    async def compact_conversation(
        ...
        final_tokens = self.estimate_messages_tokens(compacted)
        ...
        _LOGGER.info(
            ...
            len(compacted),
            current_tokens,
            self.estimate_messages_tokens(compacted),
        )
        ...
        for i, msg in enumerate(messages):
            ...
            if isinstance(content, str):
                ...
                if i < len(messages) - self.keep_last:
                    max_chars = available_tokens * chars_per_token * 2 // len(messages)
                else:
